    ...
    <div>
      <footer className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left pt-8 pl-20">
            <h2 className="title-font font-medium text-gray-900 tracking-widest text-1xl mb-3">
              Connect With Us!
            </h2>
            <div>
              <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start pl-2">
